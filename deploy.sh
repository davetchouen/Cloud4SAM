...
LOCUSER=$ID # Set this variable according to the used distrib: ubuntu 
debian centos rocky 
...
# Authorize local user to run docker 
...
'ansible_python_interpreter=/usr/bin/python3' ansible-remotefs.yaml 
